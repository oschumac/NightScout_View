...
public class SettingsActivity extends PreferenceActivity {
    ...
    /**
     * Helper method to determine if the deviVibratece has an extra-large screen. For
    ...
    public static class NotificationPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("alarm_use_Trends"));
            bindPreferenceSummaryToValue(findPreference("Hypowarnschwelle1"));
            bindPreferenceSummaryToValue(findPreference("Hypowarnschwelle2"));
            bindPreferenceSummaryToValue(findPreference("Hyperwarnschwelle"));
        }
    }
